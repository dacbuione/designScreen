...
export default class ImportEditDetail extends Component {
    constructor(props) {
        super(props);
        this.state = ({
            ...
            itemPass: this.props.navigation.getParam('item'),
            items: '',
            idItem: '',
            uom: '',
            kho: '',
    ...
    _setDataPass = () => {
        this.setState({
            items: this.state.itemPass.ma_vt,
            idItem: this.state.itemPass.ma_vt,
            soluong: this.state.itemPass.so_luong,
            gia: this.state.itemPass.gia,
            maKho: this.state.itemPass.ma_kho,
            maVT1: this.state.itemPass.ma_vi_tri,
            uomName: this.state.itemPass.dvt,
            maNX1: this.state.itemPass.ReasonCode,
            maLo1:this.state.itemPass.ma_lo
        })
    }
    ...
    _onAddItem = () => {
        ...
        this.props.navigation.state.params.save(dataDetail,this.props.navigation.getParam('index'));
        this.props.navigation.navigate('NewInputOrderContainer');
        this._onRefresh();
    }
    _onRefresh() {
        this.setState({
        ...
        if (this.state.idItem == '') {
            ...
            AsyncStorage.getItem(STORAGE_KEY).then((access_token) => {
                ...
                fetch(URL, {
                    ...
                    .then((res) => res.json())
                    .then((resData) => {
                        //console.warn('Ma lo', resData.Data);
                        this.setState({
                            dataLo: resData.Data,
                        });
                    })
